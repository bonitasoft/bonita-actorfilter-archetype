...
The project **$artifactId** is a Bonita Actor Filter for **Bonita {short-bonita-version}** written in `$language` language.
...
The build should produce a jar archive under the `target/` folder named `${artifactId}-${version}.jar`
