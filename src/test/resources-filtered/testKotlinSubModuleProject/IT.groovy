...
// Run 'mvn install' first and then 'mvn groovy:execute -Dsource=target/test-classes/testKotlinSubModuleProject/IT.groovy -Dscope=test' from project root

// Given
def sourcePath = '${project.basedir}/src/test/resources/testKotlinSubModuleProject/'
def testPath = '${project.build.testOutputDirectory}/testKotlinSubModuleProject/'
