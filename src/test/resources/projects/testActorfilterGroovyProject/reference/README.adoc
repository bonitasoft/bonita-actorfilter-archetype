...
The build should produce a zip archive under the `target/` folder named `actorfilter-groovy-test-1.0.0-all.zip`
...
Take the built artifact `actorfilter-groovy-test-1.0.0-all.zip` and import it to your Bonita Studio.
