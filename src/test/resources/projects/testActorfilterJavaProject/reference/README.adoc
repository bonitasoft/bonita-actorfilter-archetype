...
The project **actorfilter-java-test** is a Bonita Actor Filter for **Bonita {short-bonita-version}** written in `java` language.
...
The build should produce a jar archive under the `target/` folder named `actorfilter-java-test-1.0.0.jar`
