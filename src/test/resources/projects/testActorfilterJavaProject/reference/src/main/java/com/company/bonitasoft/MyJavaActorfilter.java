...
public class MyJavaActorfilter extends AbstractUserFilter {

    private static final Logger LOGGER = Logger.getLogger(MyJavaActorfilter.class.getName());

    static final String MAXIMUM_WORKLOAD_INPUT = "maximumWorkload";

    /**
     * Perform validation on the inputs defined on the actorfilter definition (src/main/resources/actorfilter-java-test.def)
     * You should: 
