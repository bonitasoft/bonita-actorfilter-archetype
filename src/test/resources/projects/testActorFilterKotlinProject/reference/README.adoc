...
The project **actorfilter-kotlin-test** is a Bonita Actor Filter for **Bonita {short-bonita-version}**  **Community** version written in `kotlin` language.
...
[source,bash]
----
git clone https://your.github.com/actorfilter-kotlin-test.git
cd actorfilter-kotlin-test/
mvn package
----

The build should produce a zip archive under the `target/` folder named `actorfilter-kotlin-test-1.0.0-all.zip`
...
Take the built artifact `actorfilter-kotlin-test-1.0.0-all.zip` and import it to your Bonita Studio.
