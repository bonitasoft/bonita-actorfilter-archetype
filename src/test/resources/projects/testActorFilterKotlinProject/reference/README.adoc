...
:short-bonita-version: 12.0
:doc-url: https://documentation.ofelia.com/bonita/{short-bonita-version}
:java-version: 17

= actorfilter-kotlin-test

The project **actorfilter-kotlin-test** is a Bonita Actor Filter for **Bonita {short-bonita-version}** written in `kotlin` language.
...
The build should produce a jar archive under the `target/` folder named `actorfilter-kotlin-test-1.0.0.jar`
